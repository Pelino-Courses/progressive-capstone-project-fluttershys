...
2. **Friction Point 2 — Uburyo bwo kwishyura (Payment Methods)**  
...
3. **Friction Point 3 — Kutabona ibicuruzwa (Stock Visibility)**  
...
4. **Friction Point 4 — Kwamamaza (Advertising)**  
...
5. **Friction Point 5 — Igihe cyo gutegereza (Wait Times)**  
...
2. **Friction Point 2 — Gukora reservations (No Pre-ordering)**  
   Customers unable to reserve items for later pickup.  
   > *"Nagombaga guza saa tatu ariko ibicuruzwa byarangiye. Byakuwe na mugenzi wanjye."*  
...
4. **Friction Point 4 — Kwanduza amakuru (Communication Loss)**  
...
5. **Friction Point 5 — Ubushobozi bwa Data (Data Usage)**  
...
**Timestamp:** 2026-03-23 | 10:00 – 10:30 AM  
**Location:** Remera Trading Center

### Observations
1. **Friction Point 1 — Kongereza ibicuruzwa (Restocking Chaos)**  
   Small vendors don't know when their supplier will deliver next.  
   > *"My supplier comes whenever — I never know the exact day."*  

2. **Friction Point 2 — Akazi k'indahemuka (No Delivery System)**  
...
3. **Friction Point 3 — Amakuru y'igiciro (Price Fluctuation Awareness)**  
...
4. **Friction Point 4 — Kutabona ibicuruzwa bisize (Unsold Stock)**  
...
5. **Friction Point 5 — Ubwizacyane (Counterfeit Goods)**  
...
## Team Synthesis — Ibibazo Ngenderwaho
